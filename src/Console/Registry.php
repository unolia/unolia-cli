...
final class Registry
{
    ...
    public const COMMANDS = [
        ...
        'domain:records' => Command\Domain\RecordsCommand::class,
        'domain:add' => Command\Domain\AddCommand::class,
        'domain:update' => Command\Domain\UpdateCommand::class,
        'domain:remove' => Command\Domain\RemoveCommand::class,
        'domain:watch' => Command\Domain\WatchCommand::class,
        'domain:dig' => Command\Domain\DigCommand::class,
